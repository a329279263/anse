    ...
    <div class="h-full flex flex-col bg-sidebar">
      ...
      <footer class="h-14 fi justify-between px-3">
        ...
        <div text-xs op-40 px-2>
          <a href="https://lzh329279263.cn/home" target="_blank" rel="noreferrer" class="hv-foreground">
            {t('docs')}
          </a>
          <span class="px-1"> · </span>
          <a href="https://github.com/a329279263/anse/" target="_blank" rel="noreferrer" class="hv-foreground">
            {t('github')}
          </a>
        </div>
      </footer>
